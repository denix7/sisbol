    ...
    <div class="container">
        ...
        <div class="row main-low-margin text-center">
            <div class="col-md-4 col-sm-4 text-center">
                <img class="img-circle" src="assets/img/facebook.png">
                <h3>Expositor 1</h3>

               	<?php
			$sql="SELECT nombre from informacion where id=1";
			...
			?>
                ...
                <p>
                    <?php
			$sql="SELECT descripcion from infoexpositor where id=1";
			$result=mysqli_query($conexion,$sql);
            ...
            <div class="col-md-4 col-sm-4 text-center">
                <img class="img-circle" src="assets/img/apple.png">
                
						
			<h3>Expositor 2</h3>

               	<?php
			$sql="SELECT nombre from infoexpositor where id=2";
			$result=mysqli_query($conexion,$sql);
			...
			?>
                ...
                <p>
                    <?php
			$sql="SELECT descripcion from infoexpositor where id=2";
			$result=mysqli_query($conexion,$sql);
            ...
            <div class="col-md-4 col-sm-4 text-center">
                <img class="img-circle" src="assets/img/whatsapp.png">
                <h3>Expositor 3</h3>

               	<?php
			$sql="SELECT nombre from infoexpositor where id=3";
			$result=mysqli_query($conexion,$sql);
			...
			?>
                ...
                <p>
                   <?php
			$sql="SELECT descripcion from infoexpositor where id=3";
			$result=mysqli_query($conexion,$sql);
